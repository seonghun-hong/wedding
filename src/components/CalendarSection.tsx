...
export function CalendarSection() {
  ...
  useEffect(() => {
    const timer = window.setInterval(() => setRemain(getRemain()), 1000);
    return () => window.clearInterval(timer);
  }, []);

  return (
    <section className="section calendar-section">
      <h2 className="section-title normal-case">Calendar</h2>

      <div className="calendar-card">
        <img src={asset("/images/calendar.jpg")} alt="달력 배경" className="calendar-bg" />
        <div className="calendar-overlay" />

        <div className="calendar-inner">
          <h3>{invitation.wedding.year}년 {invitation.wedding.month}월</h3>
      ...
      <div className="countdown">
        <CountItem label="DAYS" value={remain.days} />
      ...
      <p className="dday">
        {invitation.groom.name}, {invitation.bride.name}의 결혼식이 <b>{remain.days}일</b> 남았습니다.
      </p>
    </section>
  );
}
